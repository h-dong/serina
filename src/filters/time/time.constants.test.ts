...
describe('TIME', () => {
    describe('FORMAT_NORMAL', () => {
        test.each([['4am'], ['4 am'], ['04:30'], ['04:30am'], ['04:30 am']])('should match %s', input => {
    ...
    describe('RELATIVE_TIME_FILLER_WORDS', () => {
        test.each([['to'], ['until'], ['after'], ['past']])('should match %s', input => {
    ...
    describe('HOUR_PART', () => {
        test.each([[0], ['00'], ['4'], ['04'], ['12'], ['23']])('should match %s', input => {
    ...
    describe('MINUTE_PART', () => {
        test.each([['00'], ['01'], ['59']])('should match %s', input => {
    ...
    describe('DIVIDER', () => {
        test.each([[':']])('should match %s', input => {
    ...
    describe('MERIDIEM', () => {
        test.each([['am'], ['pm']])('should match %s', input => {
    ...
    describe('AM', () => {
        test.each([['am']])('should match %s', input => {
    ...
    describe('PM', () => {
        test.each([['pm']])('should match %s', input => {
    ...
    describe('TO', () => {
        test.each([['to'], ['until']])('should match %s', input => {
    ...
    describe('PAST', () => {
        test.each([['past', ['after']]])('should match %s', input => {
    ...
    describe('HALF', () => {
        test.each([['half']])('should match %s', input => {
    ...
    describe('QUARTER', () => {
        test.each([['quarter']])('should match %s', input => {
    ...
    describe('VERBAL_QUANTIFIERS', () => {
        test.each([['half'], ['quarter']])('should match %s', input => {
    ...
    describe('MINUTE_IDENTIFIER', () => {
        test.each([['min'], ['mins'], ['minute'], ['minutes']])('should match %s', input => {
    ...
    describe('FILLER_WORDS', () => {
        test.each([['at'], ['by']])('should match %s', input => {
    ...
    describe('WITH_FILLER_WORDS', () => {
        test.each([['by 4am'], ['at 4 am']])('should match %s', input => {
