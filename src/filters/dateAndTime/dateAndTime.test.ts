...
describe('DateAndTime', () => {
    ...
    describe('should parse relative date and time (date first)', () => {
        test.each([
            ...
            { filter: 'in 31 days at 9am', dateTime: mockDates(currentDay + 31, currentMonth, currentYear, 9, 0) },
            ...
            { filter: 'in 5 weeks 12am', dateTime: mockDates(currentDay + 35, currentMonth, currentYear, 0, 0) },
            { filter: 'in a wk 0:00', dateTime: mockDates(currentDay + 7, currentMonth, currentYear, 0, 0) },
            { filter: 'in 5 wks at 4PM', dateTime: mockDates(currentDay + 35, currentMonth, currentYear, 16, 0) },
    ...
    describe('should parse relative date and time (time first)', () => {
        test.each([
            ...
            { filter: 'at 9am in 31 days', dateTime: mockDates(currentDay + 31, currentMonth, currentYear, 9, 0) },
            ...
            { filter: '12am in 5 weeks', dateTime: mockDates(currentDay + 35, currentMonth, currentYear, 0, 0) },
            { filter: '0:00 in a wk', dateTime: mockDates(currentDay + 7, currentMonth, currentYear, 0, 0) },
            { filter: 'at 4PM in 5 wks', dateTime: mockDates(currentDay + 35, currentMonth, currentYear, 16, 0) },
