import { weekdayStringToDateObj, weekdayStringToNumber } from 'parsers/weekday/weekday.helpers';
...
describe('Weekday Helpers', () => {
  describe('convertWeekdayStringToNumber()', () => {
    ...
    test('returns null when no weekday is present', () => {
      expect(weekdayStringToNumber('not a weekday', false)).toBeNull();
    });
  });
