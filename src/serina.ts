...
import DateAndTime from './filters/dates/dateAndTime/dateAndTime';
...
const serina = (text: string): ParsedSchema => {
    ...
    const filters = [ WeekDay, Day, Month, Year, Time, Dates, PartialDates, DateAndTime, RelativeTime, RelativeDates ];
